  ...
  useEffect(() => {
    const structuredData = {
      ...
      hasOccupation: {
        ...
        description: "Full-stack software engineer specializing in full-stack web development.",
      },
      makesOffer: {
        "@type": "Offer",
    ...
    if (scriptRef.current) {
      // Create a wrapper for multiple structured data objects
      const combinedData = [structuredData, faqData];
      scriptRef.current.textContent = JSON.stringify(combinedData);
    }
  }, []);
