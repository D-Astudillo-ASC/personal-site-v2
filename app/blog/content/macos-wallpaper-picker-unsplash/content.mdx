...
Downloads use [FileManager.urls(for:in:)](https://developer.apple.com/documentation/foundation/filemanager/1407693-urls) with `.cachesDirectory` and `.userDomainMask`:
...
The supported API to change the wallpaper is [setDesktopImageURL(_:for:options:)](https://developer.apple.com/documentation/appkit/nsworkspace/1527239-setdesktopimageurl) on [NSWorkspace.shared](https://developer.apple.com/documentation/appkit/nsworkspace):

```swift
try workspace.setDesktopImageURL(self.imgPath!, for: screen, options: [:])
```

You can read the current image with [desktopImageURL(for:)](https://developer.apple.com/documentation/appkit/nsworkspace/1528728-desktopimageurl) — the app tried to delete the previous file before applying the new one. That often fails while the system still references the path; the code logs and continues, which matches real-world desktop automation.
...
| Topic | Link |
| --- | --- |
| NSWorkspace | [NSWorkspace — Apple Documentation](https://developer.apple.com/documentation/appkit/nsworkspace) |
| setDesktopImageURL | [setDesktopImageURL(_:for:options:)](https://developer.apple.com/documentation/appkit/nsworkspace/1527239-setdesktopimageurl) |
| File locations | [File System Overview](https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/FileSystemProgrammingGuide/FileSystemOverview/FileSystemOverview.html) |
| SDWebImageSwiftUI | [SDWebImageSwiftUI on GitHub](https://github.com/SDWebImage/SDWebImageSwiftUI) |
| Unsplash API | [Unsplash API documentation](https://unsplash.com/documentation) |
