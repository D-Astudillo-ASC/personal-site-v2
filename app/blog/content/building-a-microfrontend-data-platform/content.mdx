...
After moving a hot API from [**21s to ~250ms**](/blog/cutting-a-data-api-from-21s-to-250ms), the next bottleneck was frontend coordination: **N product UIs, one authenticated session, zero cross-team deploy coupling**. This post covers the platform shell pattern — host + federated remotes + BFF seam — without tying it to any single product name.
...
**External:** [Module Federation concepts](https://module-federation.io/guide/basic/introduction.html) · [Auth0: Token Exchange (RFC 8693)](https://auth0.com/docs/authenticate/protocols/token-exchange) · [Rspack Module Federation plugin](https://module-federation.io/guide/basic/rspack)
