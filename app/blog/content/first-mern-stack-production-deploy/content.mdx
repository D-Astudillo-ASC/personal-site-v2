...
References: [NGINX reverse proxy](https://docs.nginx.com/nginx/admin-guide/web-server/reverse-proxy/), [Medium — MERN on EC2](https://medium.com/@Keithweaver_/setting-up-mern-stack-on-aws-ec2-6dc599be4737) (the tutorial our team used).
...
| Topic | Link |
| --- | --- |
| NGINX reverse proxy | [NGINX — reverse proxy](https://docs.nginx.com/nginx/admin-guide/web-server/reverse-proxy/) |
| PM2 process management | [PM2 documentation](https://pm2.keymetrics.io/docs/usage/quick-start/) |
| MERN on EC2 (tutorial era) | [Medium — MERN on AWS EC2](https://medium.com/@Keithweaver_/setting-up-mern-stack-on-aws-ec2-6dc599be4737) |
