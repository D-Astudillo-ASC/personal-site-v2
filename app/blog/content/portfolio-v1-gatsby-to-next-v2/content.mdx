...
| Topic | Link |
| --- | --- |
| Gen 1 live | [v1.danielastudillo.io](https://v1.danielastudillo.io/) |
| Gen 2 live | [v2.danielastudillo.io](https://v2.danielastudillo.io/) |
| Gen 3 live | [danielastudillo.io](https://danielastudillo.io/) |
| Next.js App Router | [Next.js — App Router](https://nextjs.org/docs/app) |
| Gatsby → headless migration patterns | [Gatsby migration guide](https://www.gatsbyjs.com/docs/how-to/performance/migrate-from-gatsby-to-next-js/) |
