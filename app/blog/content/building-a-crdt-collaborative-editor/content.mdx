...
**External:** [Yjs documentation](https://docs.yjs.dev/) · [y-monaco](https://github.com/yjs/y-monaco) · [Socket.IO rooms](https://socket.io/docs/v4/rooms/) · Shapiro et al., [*A comprehensive study of CRDTs*](https://hal.science/hal-01555508) — why "apply in any order, converge always" is a design goal
