...
**External:** [Gemini text generation (streaming)](https://ai.google.dev/gemini-api/docs/text-generation#streaming) · [MDN: Server-sent events](https://developer.mozilla.org/en-US/docs/Web/API/Server-sent_events/Using_server-sent_events)
